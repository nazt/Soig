...
<script language="javascript" src="http://localhost/nusoap/confirm.js"></script>
<script language="javascript" src="http://localhost/nusoap/jquery.simplemodal.js"></script>
...
$form_input_data = array(
			...
			echo form_open('CarReservation/confirm', $attributes);
 ?>
...
<?php foreach ($id as $key=>$value): ?> 
 ...
 <table border="0" cellspacing="1" cellpadding="1">
	...
	<?=form_hidden('rate[]', $erate[$key]);?>
 	...
 	<tr  class="prop"><th>Fuel</th><td><?=$detail[$value]["fuel"]?></td></tr>
 	<tr  class="prop"><th>carType</th><td><?=$detail[$value]["type"]?></td></tr>
 	...
 	<tr  class="prop">
		...
		<select name="pickupDate_month[]" id="pickupDate_month">
		...
		<select name="pickupDate_year[]" id="pickupDate_year">
		<option value="1909"
		>1909</option>
	...
	<tr  class="prop">
		<th>pickupDate</th><td><select name="dropOffDate_day[]" id="dropOffDate_day">
		<option value="1"
		>1</option>
		...
		<select name="dropOffDate_month[]" id="dropOffDate_month">
		<option value="1">January</option>
		<option value="2">February</option>
		<option value="3">March</option>
		<option value="4">April</option>
		...
		<select name="dropOffDate_year[]" id="dropOffDate_year">
		<option value="1909"
		>1909</option>
